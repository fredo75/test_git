class Personne
  ...
  def attaque(personne)
    ...
    if personne.en_vie
      ...
      puts "#{nom} attaque #{personne.nom} déjà vaincu !"
    end
  end
...
class Joueur < Personne
  ...
  def degats
    ...
    # - Calculer les dégats
    # - Affiche ce qu'il s'est passé
    puts "#{nom} profite de #{degats_bonus} degats infliges aux ennemis"
    return rand(20..25) + degats_bonus 
...
class Ennemi < Personne
  def degats
    # A faire:
    # - Calculer les dégats
    return (points_de_vie)/rand(25..45)
  end
end
